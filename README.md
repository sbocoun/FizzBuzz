...
own implementation in Python to help you begin to create a mapping between the two languages.
   ...
   - for loop simply includes variable iteration and declaration within the initialization
...
Different:
 - declaration of variable type (statically typed)
 - All expressions enclosed in brackets ()
 - All statements enclosed in {} e.g. for loops
...
the file. Then click the commit button to commit the change to the repository. Done. Beep boop.
